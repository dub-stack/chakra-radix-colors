...
export const DrawerExample: ComponentStory<typeof _DrawerExample> = (args) => {
  return (
    <Decorators
...
export const WithLongContent: ComponentStory<typeof _WithLongContent> = (
  args
) => {
  return (
    <Decorators
