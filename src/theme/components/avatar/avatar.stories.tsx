...
export const WithCustomIcon: ComponentStory<typeof Avatar> = (args) => {
  return (
    <Decorators
 ...
 */
export const _WithSizes = (props: AvatarBadgeProps) => (
  <Stack direction="row" spacing="24px">
    {["xs", "sm", "md", "lg", "xl", "2xl"].map((size) => (
      ...
      >
        <AvatarBadge boxSize="1.25em" bg="green.500" {...props} />
      </Avatar>
    ))}
  </Stack>
);

export const WithSizes: ComponentStory<typeof Avatar> = (args) => {
  return (
    <Decorators
...
export const AvatarGroups: ComponentStory<typeof Avatar> = (args) => {
  return (
    <Decorators
